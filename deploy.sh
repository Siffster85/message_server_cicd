# Variables
KEY_PATH=~/.ssh/yousiff_cloud_deployment.pem
EC2_HOST=ec2-user@3.11.81.177
...
ssh -i $KEY_PATH $EC2_HOST << EOF
  ...
  docker run -p 5002:5002 \
    ...
    -e POSTGRES_PASSWORD=!Messages123 \
    -e POSTGRES_HOST=yousiff-message-server-db.cvruukypsgyb.eu-west-2.rds.amazonaws.com \
